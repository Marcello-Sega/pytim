...
MISMATCH_CLUSTER_SEARCH = "cluster_cut should be either a scalar or an array matching the number of groups (including analysis_group)"
...
WRONG_UNIVERSE = "Wrong Universe"
UNDEFINED_ANALYSIS_GROUP = "No analysis_group defined, or empty"
WRONG_ANALYSIS_GROUP = "Wrong analysis group"
