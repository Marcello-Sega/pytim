...
class QuasiTriangulation():
	...
	def triangulation(self):
		...
		for pi in sortedListOdRadii:
			...
			for face in incidentFaces:
				...
				radius=gtool.tsphere(face[0],face[1],face[2],index, self.points, self.weights, center)
	...
	def generateFirstTetrahedron(self,CoM):
		...
		while(isOutside):
			...
			tetraCoM/=4.0
			self.touchingRadii[0]=gtool.tsphere(self.simplices[0][0],self.simplices[0][1],self.simplices[0][2],self.simplices[0][3],
